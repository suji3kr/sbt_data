...
class MemberServiceTest {
    ...
    void 회원가입() {
        ...
        //then
        Member findMember = memberService.findOne(saveId).get();                 //Assertions 는 core 로 import 잡아야한다.
        assertThat(member.getName()).isEqualTo(findMember.getName());    // Assertions 잡고 alt+enter ->import
                                                                            // 다시 ctrl +alt +O
    }
